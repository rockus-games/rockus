...
for (var i = 0; i < recommended_game_count; i++) {
  ...
  for (var j = 0; j < 4; j++){
    poster_images.innerHTML += `<div onmouseover="poster_image_change(${j+2})" onmouseout="poster_image_unchange()" id="cartochka${j+1}" class="cartochki"><img width="100" height="100" src="./assets/images/recommended/game${i+1}/image${j+2}.jpeg"></div>`;
  }
}
